package com.callv2.dns.manager.adapter.record;
...
import com.callv2.dns.manager.adapter.record.persistence.InMemoryDnsRecordRepository;
...
@Component
@Profile({ "cloudflare" })
public class DefaultRecordGateway implements DnsRecordGateway {
